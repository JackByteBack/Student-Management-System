...
<div class="container" style="width: 100%">
  ...
  <div class="row">
    ...
    <div id="login-box" style="margin-top: 45px;">
        ...
        <div class="footer_login" style="">Developed By: <a href="https://github.com/amirhamza05/Student-Management-System"><font style="font-size: 19px;font-weight: bold;color: #F64343">JackByteBack</font></a></div>
    </div>
